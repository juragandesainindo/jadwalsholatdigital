...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/jadwal9.css') }}">
...
<body>
                                ...
                                <div class="card-second">
                                    <div class="card-vertical-wrapper">
                                        <div class="card-detail text-sm">
                                            <img src="{{ asset('assets/img/icMoney/ic_masuk.svg') }}">
                                            <div class="card-title">
                                                <span>Pembayaran Lahan Tanah</span>
                                                <p>28 Maret 2025</p>
    ...
    <script src="{{ asset('assets/js/sliderKeuangan.js') }}"></script>
</body>
